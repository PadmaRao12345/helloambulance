...
<script type="text/javascript">
	$(document).ready(
				...
				$("#packages-grid").jqGrid(
						{
							datatype : 'json',
							mtype : 'Get',
							url : "<c:url value='/Hospitals/hospitals'/>",
							colNames : [ 'register_hospital_id', 'hospital_name',
									'hospital_reg_no','hospital_type', 'hospital_website', 'no_of_doctors','equipments',
									'country', 'state', 'city', 'pincode','date_of_register','Delete'],
							colModel : [ {
								name : 'register_hospital_id',
								index : 'register_hospital_id',
								width : 55,
								editable : true,
								editoptions : {
									readonly : true,
	 ...
	 function linkFormatter(cellValue, options, rowdata, action) {
		  return "<button class=' btn-primary btn-xs'><a href='/helloambulance/list/deletehospital?register_hospital_id=" + rowdata.register_hospital_id + "' >Delete</a></button>";
		}
	...
	$("#mySearch").click(function () {
	     ...
	     f = { groupOp: "OR", rules: [] };
	     f.rules.push({ field: "register_hospital_id", op: "cn", data: searchFiler });
	     f.rules.push({ field: "hospital_name", op: "cn", data: searchFiler });
	     f.rules.push({ field: "hospital_reg_no", op: "cn", data: searchFiler });
	     f.rules.push({ field: "hospital_type", op: "cn", data: searchFiler });
	     f.rules.push({ field: "hospital_website", op: "cn", data: searchFiler });
	     f.rules.push({ field: "no_of_doctors", op: "cn", data: searchFiler });
