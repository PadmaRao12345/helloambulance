...
<body>
	<center>
		...
		<h2>Uploading Slides In MainPage</h2>
		<form action='<c:url value="/admin/uploadslides" />' method='POST'
			enctype="multipart/form-data">
			<form action='<c:url value="/admin/uploadslides2" />' method='POST'
			enctype="multipart/form-data">
			<table id="fileUploadFormBeanTable" border="0" width="80%">
				...
				<tr>
					<td>Attachment:</td>
					<td><input id="attachment" type="file" name="attachFileObj"
						size="60" /> <span id="fileUploadErr">Please Upload A
							Image!</span></td>
				</tr>

				<tr>
					<td colspan="1" align="center"><input id="submit"
