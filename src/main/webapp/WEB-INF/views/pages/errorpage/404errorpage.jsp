...
<div id="content">
 <div class="content-container"><fieldset>
  ...
  <h3>requested page not avaible.</h3>
 </fieldset></div>
</div>
</body>
</html>
...
<div class="wrap">
  <article>
    ...
    <p id="fittext2">page not found</p>
     <p id="fittext3">requested page not avaible</p>
     <!-- <p id="fittext4"> <a href="http://localhost:2018/helloambulance/"> click here to login</a>with username or password</p>
       <p id="fittext5"><a href="http://localhost:2018/helloambulance/">Home</a></p>
   -->
  </article>
</div>
