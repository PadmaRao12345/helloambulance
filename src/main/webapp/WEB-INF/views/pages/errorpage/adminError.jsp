...
<body>
<div id="header"><h1>Access Denied</h1></div>
<div id="content">
...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
  ...
  <%--   
   ...
   <html> <body bgcolor="white">
    <center>
 <form name="Form"
		   action='<c:url value="/adminlogin/error"/>'    method='POST'>
		    	<h3>your are not authenticated or not allowed</h3>
		    	<h3> please login with username Or password</h3>		
       <a href="http://localhost:2018/helloambulance/adminlogin">click here to login</a><br>
             <a href="http://localhost:2018/helloambulance/">go back to homepage </a>
...
<div class="wrap">
  <article>
    ...
    <p id="fittext2">Access Denied</p>
     <p id="fittext3">you are not authenticated</p>
     <p id="fittext4"><a href='<c:url value="/adminlogin/"/>'>click here to login</a>with username or password</p>
     <p id="fittext5"><a href='<c:url value="/"/>'>Home</a></p>
  </article>
</div>
...
<script type="text/javascript">
    ...
    $("#fittext3").fitText(1.8);
    $("#fittext4").fitText(2.5);
    $("#fittext5").fitText(2.0);
