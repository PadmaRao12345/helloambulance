...
<h4 style="color:red;">Enter your registered email address:</h4>
	<form action="resetPassword" method="POST">
		<table>
			...
			<tr>
				<td><input type="Submit" value="Reset Password" id="submit"><a href="http://localhost:8080/helloambulance/newPassword/email_id"></a> </td>
...
$(document).ready(function() {
	$("#email_id").change(function() {
		$.ajax({
			url : 'forgotpassword_check_availEmail_user',
			data : {
