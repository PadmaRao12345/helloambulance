...
$(document).ready(function(){
	...
	var hospital_name = $("#hospital_name").val();
			...
			success : function(result){
				alert("Hospital Regisration Completed Successfully");
			...
			<div class="row " id="regdiv">
				<div class="col-sm-9">
					<div class="panel panel-primary setup-content">
						...
						<div class="panel-body">
							...
							<form action="updateHospital" method="POST" id="register">
							<!-- <form action="hospitalregistration" method="POST"> -->
								<div class="group input_form_sign ">
									<input class="inputMaterial" type="text" name="hospital_name" value="${hospital.hospital_name }"
								...
								<label>Hospital Reg-No</label>
									<input class="inputMaterial" type="text" name="hospital_reg_no" value="${hospital.hospital_reg_no }" readonly="readonly"
										id="hospital_reg_no" required> 
								...
								<div class="group input_form_sign  ">
									...
									<div class="lef">
										...
										<div class="group input_form_sign ">
										<label>Address</label>
										<input class="inputMaterial" type="text" name="hospital_address" value="${hospital.hospital_address }"
									...
									<%-- <div class="group input_form_sign ">
										<select name="country" class="inputMaterial gender"
											id="country" required>
											<option value="101">${hospital.country }</option>
									...
									<div class="group input_form_sign ">
									<label>Country</label>
									<input class="inputMaterial" type="text" name="country" value="${hospital.country}" readonly="readonly"
										id="country" required>

								</div>
								<div class="group input_form_sign ">
								<label>State</label>
									<input class="inputMaterial" type="text" name="state" value="${hospital.state}" readonly="readonly"
										id="state" required> 
								</div>

									<div class="group input_form_sign ">
									<label>City</label>
									<input class="inputMaterial" type="text" name="city" value="${hospital.city}" readonly="readonly"
										id="city" required> 
									...
									<%-- <div class="group input_form_sign ">
										<select name="state" class="inputMaterial gender" id="state"
											required>
											<option value="2">${hospital.state }</option>
									...
									<div class="group input_form_sign ">
									<label>pincode</label>
										<input class="inputMaterial" type="text" name="pincode" value="${hospital.pincode }" readonly="readonly"
									...
									<div class="group input_form_sign ">
										<input class="inputMaterial" type="text" name="hospital_website" value="${hospital.hospital_website }"
									...
									<div class="group input_form_sign ">
										<input class="inputMaterial" type="text" name="no_of_doctors" value="${hospital.no_of_doctors }"
								...
								<div class="group input_form_sign">
									...
									<div class="col-sm-1 col-md-5"><label>Hospital Timings:</label></div>
										<div class="col-sm-2 col-md-3">
											<input type="text" name="from_time" id="from_time" value="${hospital.from_time }"
										...
										<div class="col-sm-2 col-sm-offset-2 col-md-3 col-md-offset-0">
											...
											<input type="text" name="to_time" id="to_time" value="${hospital.to_time }"
												class="inputMaterial timepicker" required /> <span
												class="highlight"></span> <span class="bar"></span>
											<div class="lef">
												<label>To Time</label>
               ...
               <div class="cols-sm-10">
                 <div class="input-group equipment">
                      ...
                      <input type="checkbox" class="input-group equipment">
                         <div class="cols-sm-10">
