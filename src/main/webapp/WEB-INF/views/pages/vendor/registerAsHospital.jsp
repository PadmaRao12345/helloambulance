		...
		<div class="row ">
			<div class="col-sm-9 ">
				<div>
					...
					<span class="title">Mobile No:</span> <span
						class="profileMobileNumber"> </span><br> <span class="title">Date
						Of Birth:</span> <span class="profileDateOfBirth"> </span><br> <span
						class="title">Gender:</span> <span class="profileGender"></span><br>
					<span class="title">BloodGroup:</span> <span
						class="profileBloodGroup"> </span><br> <span class="title">Register
						As:</span> <span class="profileRegisterAs"></span><br>
				</div>
			</div>
		</div>
	</div>
