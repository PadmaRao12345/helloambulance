...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
  ...
  </nav>  <div class="container-fluid" style="margin-top: 75px;" >
...
<li > <div class="link"><a  href="ourDoctorsforHospital" >Our Doctors</a></div></li>
<li > <div class="link"><a  href="ourAmbulancesforHospital" >Our Ambulances</a></div></li>

<li>
  			<div class="link"><i class="fa fa-code"></i>My Account<i class="fa fa-chevron-down"></i></div>
        <ul class="submenu">
  		  <li ><div class="link"><a  href="<c:url value='/vendor/'/>">My profile</a></div></li>
  		  		 <li ><div class="link"><a  href="HospitalProfile">Hospital profile</a></div></li>
  		<li > <div class="link"><a  href="registration" >Hospital Registration</a></div></li> 		
        </ul>
  		</li>
...
<li>
        ...
        <ul class="submenu">
                <li ><div class="link"><a href='<c:url value="hospitalupdatePage"/>'>Update Hospital Profile</a></div></li>
      ...
      <!-- class="default open" -->
  			...
  			<div class="link"><i class="fa fa-code"> </i>Add Equipments<i class="fa fa-chevron-down"></i></div>
  		  		        <ul class="submenu">
  		  		 <li ><div class="link"><a href='<c:url value="addNewEquipments"/>'>Equipments</a></div></li> 
  		</ul>
  		<li>
        ...
        <ul class="submenu">
          ...
          <li class="link" ><a href="ambregforhospital" > Ambulance Services</a> </li>
           <li class="link" ><a href="docreg" > Doctor Services</a> </li>
