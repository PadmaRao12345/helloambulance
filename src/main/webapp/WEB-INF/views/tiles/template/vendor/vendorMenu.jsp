      ...
      <h2><span class="profileName"></span>  <small><i class="fa fa-map-marker"></i> <span class="profileCountry"></span> <span class="profileState"></span></small></h2>
        ...
        <ul class="submenu">
         <li ><div class="link"><a  href="<c:url value='/vendor/'/>">My profile</a></div></li>
  		<li > <div class="link"><a  href="registration" >Doctor Registration</a></div></li> 
  		<li > <div class="link"><a  href="DoctorProfile" >Doctor Profile</a></div></li> 		
        </ul>
  		</li>
...
<li>
        ...
        <ul class="submenu">
                <li ><div class="link"><a href='<c:url value="doctorUpdatePage"/>'>Update Doctor Profile</a></div></li>
      ...
      <!-- class="default open" -->
  			<li>
  			<div class="link"><i class="fa fa-code"> </i>Add Specializations<i class="fa fa-chevron-down"></i></div>
  		  		        <ul class="submenu">
                <li ><div class="link"><a href='<c:url value="addNewDoctorSpecialization"/>'>Specializations</a></div></li>
  		</ul>
